...
\begin{itemize}
  \item USA~Swimming continues to expose the public REST endpoints
        \code{times-api.usaswimming.org/swims/TimesSearch/%
        GetMembersForFilters} and
        \code{.../swims/TimesSearch/BestTimes} to anonymous callers.
